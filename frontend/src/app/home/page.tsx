        ...
        {loading ? (
          ...
          <Stack
            ...
            sx={{
              ...
              // flexWrap: "wrap",
              // justifyContent: "center",
              marginLeft: "-400px", // Ajusta este valor según tus necesidades
              "& > :not(style)": {
            ...
            {services.length === 0 ? (
              ...
              services.map((service) => (
                ...
                >
                  <Box sx={{ flex: 1 }}>
                    {" "}
                    {/* Esta Box contendrá los textos */}
                    <Typography
                      variant="h6"
                      sx={{ color: "#657786", fontWeight: "bold" }}
                    >
                    ...
                    <Typography variant="body2" sx={{ color: "#657786" }}>
                      Services date:{" "}
                      {new Date(service.serviceDateIni).toLocaleString()} -{" "}
                    ...
                    <Typography variant="body2" sx={{ color: "#657786" }}>
                      ID of the pet: {service.petId}{" "}
                      {/* Muestra el petId aquí */}
                    </Typography>
                    <Typography
                      variant="body2"
                      sx={{
                        fontWeight: "bold",
                        color: service.completed ? "green" : "red",
                      }}
                    >
                  ...
                  <Box sx={{ marginLeft: 2 }}>
                    {" "}
                    {/* Esta Box contendrá la imagen */}
                    <Typography variant="h6" sx={{ color: "#657786" }}>
                      Photos
                    </Typography>
                    <img
